            ...
            <div class="col-lg-6">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label for="kode_pos">Postsl Code</label>
                            <input type="text" name="kode_pos" class="form-control" id="kode_pos" placeholder="Address" value="<?= $model->kode_pos ?>" required readonly style="background: white;">
                        </div>
