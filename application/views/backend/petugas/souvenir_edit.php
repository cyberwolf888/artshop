                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="<?= $model->name ?>" class="form-control" id="name" placeholder="Souvenir Name" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="price" value="<?= $model->price ?>" class="form-control" id="price" placeholder="Price" required>
                        </div>
                        <div class="form-group">
                            <label for="discount">Discount (%)</label>
                            <input type="number" value="<?= $model->discount ?>" name="discount" class="form-control" id="discount" placeholder="Discount" required>
                        </div>
                        <div class="checkboxes">
                            <label class="label_check c_off" for="checkbox-01">
                                <input name="isAvailable" id="checkbox-01" value="1" type="checkbox" <?= $model->isAvailable == 1 ? 'checked' : '' ?>>
                                Is Item Available
                            </label>
                            <label class="label_check c_off" for="checkbox-02">
                                <input name="isHot" id="checkbox-02" value="1" type="checkbox" <?= $model->isHot == 1 ? 'checked' : '' ?>>
                                Hot Item
                            </label>
                            <label class="label_check c_off" for="checkbox-03">
                                <input name="isSale" id="checkbox-03" value="1" type="checkbox" <?= $model->isSale == 1 ? 'checked' : '' ?>>
                                Sale Item
                            </label>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="input_fields_wrap">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <input type="text" name="value[]" class="form-control" id="value" placeholder="Value" value="<?= $dRow->value ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-2">
