        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="owl-carousel owl-theme" data-plugin-options='{"items": 1}'>
                    <div>
                        <div class="thumbnail">
                            <img alt="" class="img-responsive img-rounded" src="<?= base_url() ?>frontend/assets/img/products/product-7.jpg">
                        </div>
                    </div>
                    <div>
                        <div class="thumbnail">
                            <img alt="" class="img-responsive img-rounded" src="<?= base_url() ?>frontend/assets/img/products/product-7-2.jpg">
                        </div>
                    </div>
                    <div>
                        <div class="thumbnail">
                            <img alt="" class="img-responsive img-rounded" src="<?= base_url() ?>frontend/assets/img/products/product-7-3.jpg">
                        </div>
                    </div>
                </div>
                                ...
                                <li>
                                    <div class="comment">
                                        <div class="img-thumbnail">
                                            <img class="avatar" alt="" src="<?= base_url() ?>frontend/assets/img/avatar-2.jpg">
                                        </div>
